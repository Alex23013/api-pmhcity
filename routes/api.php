...
Route::middleware('auth:sanctum')->group( function () {
    ...
    Route::post('deliveries/validate', [ReservationController::class, 'validateDeliveryCode']);
});
...
Route::post('/email-tokens/generate', [EmailTokenController::class, 'generateToken']);
Route::post('/email-tokens/verify', [EmailTokenController::class, 'verifyToken']);
...
Route::get('top-products', [ProductController::class, 'listTopProducts']);
...
Route::get('/v2/categories/{id}', [CategoryController::class, 'show']);
